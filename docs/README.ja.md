...
*実際の動作 — デジタルヒューマンが知乎・Bilibili・小紅書・X を24時間操作（ストアに既製スキルあり）：*
...
自分で作りたい？ ログインが必要な社内システムを定期的に巡回する **OA 承認アシスタント** を作る完全ガイドがドキュメントにあります：[**Browser Skill デジタルヒューマンを作る →**](https://hello-halo.cc/docs/digital-humans/guide-02-build.html)
