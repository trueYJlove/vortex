...
*實際效果 — 數位人 7x24 操作知乎、B站、小紅書與 X（商店有現成 Skill）：*
...
想自己打造一個？完整教學——打造一個定時巡檢登入態內部系統的 **OA 審批助手**——詳見文件：[**打造 Browser Skill 數位人 →**](https://hello-halo.cc/docs/digital-humans/guide-02-build.html)
